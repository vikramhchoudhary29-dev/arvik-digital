export default function AboutHero() {
  return (
    <section className="relative overflow-hidden pt-36 pb-20 hero-grid">
      <div className="absolute left-1/2 top-0 h-[500px] w-[500px] -translate-x-1/2 rounded-full bg-yellow-500/15 blur-[160px]" />
      ...
      <div className="container relative text-center">
        ...
        <h1 className="mx-auto max-w-5xl text-5xl font-black leading-tight md:text-7xl">
          ...
          <span className="gold-text"> Create Real Business Impact</span>
        </h1>
        ...
        <p className="mx-auto mt-7 max-w-3xl text-lg leading-8 text-zinc-400">
          ...
          premium websites, custom software, AI solutions, branding, and digital
          marketing.
        </p>
      </div>
    </section>
